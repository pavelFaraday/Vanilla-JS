// Filter - **returns a new array**, can manipulate the size of new array (unlike map), returns based on condition. If it doesn't find any matching item, returns empty array [];
